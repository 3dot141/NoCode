...
- **Single Source of Truth**: All skills must reside in `/Users/yes365/Run/NoCode/skills/`
...
```bash
bash /Users/yes365/Run/NoCode/skills/skills-manager/scripts/list_skills.sh
```
...
```bash
bash /Users/yes365/Run/NoCode/skills/skills-manager/scripts/link_global.sh <skill-name>
```
...
```bash
bash /Users/yes365/Run/NoCode/skills/skills-manager/scripts/link_project.sh <skill-name>
```
...
```bash
bash /Users/yes365/Run/NoCode/skills/skills-manager/scripts/check_links.sh
```
...
```bash
bash /Users/yes365/Run/NoCode/skills/skills-manager/scripts/remove_skill.sh <skill-name>
```

## Adding New Skills

1. Copy skill folder to `/Users/yes365/Run/NoCode/skills/<skill-name>/`
...
```
/Users/yes365/Run/NoCode/skills/     # Central repository (all skills here)
